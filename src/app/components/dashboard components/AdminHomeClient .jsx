...
const AdminHomeClient = ({ classes, users, bookings, admin }) => {
  ...
  const approvedClasses = classes?.filter(c => c.status === "approved")?.length || 0;
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-16 sm:px-10 lg:px-16">
        ...
        >
          ...
          <div className="group relative rounded-2xl border border-white/10 bg-white/5 p-6 transition-all duration-300 hover:border-lime-300/30 hover:bg-white/10 hover:scale-[1.02]">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-white/30">Registered members</p>
              </div>
            ...
            <div className="mt-4 h-1 w-full rounded-full bg-white/5">
              <div
                ...
                style={{ width: `${Math.min(totalUsers * 2, 100)}%` }}
              />
            </div>
          </div>
          ...
          <div className="group relative rounded-2xl border border-white/10 bg-white/5 p-6 transition-all duration-300 hover:border-lime-300/30 hover:bg-white/10 hover:scale-[1.02]">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm font-medium text-white/40">Total Classes</p>
                <p className="mt-2 text-3xl font-bold text-white">{totalClasses}</p>
            ...
            <div className="mt-4 h-1 w-full rounded-full bg-white/5">
              <div
                ...
                style={{ width: `${Math.min(approvedClasses * 4, 100)}%` }}
              />
            </div>
          </div>
          ...
          <div className="group relative rounded-2xl border border-white/10 bg-white/5 p-6 transition-all duration-300 hover:border-lime-300/30 hover:bg-white/10 hover:scale-[1.02]">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm font-medium text-white/40">Total Bookings</p>
                <p className="mt-2 text-3xl font-bold text-white">{totalBookings}</p>
                <p className="mt-1 text-xs text-white/30">Classes booked</p>
              </div>
            ...
            <div className="mt-4 h-1 w-full rounded-full bg-white/5">
              <div
                ...
                style={{ width: `${Math.min(totalBookings * 2, 100)}%` }}
              />
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 transition-all duration-300 hover:border-lime-300/30 hover:bg-white/10">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full border bg-purple-500/20 text-purple-400 border-purple-500/30">
                    {admin?.role || "admin"}
                  </span>
                </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-2">
                <FiAward className="h-4 w-4 text-purple-400" />
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 transition-all duration-300 hover:border-lime-300/30 hover:bg-white/10">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between border-b border-white/10 pb-3">
                <span className="text-sm text-white/60">Total Classes</span>
                <span className="text-lg font-bold text-white">{totalClasses}</span>
              </div>
              <div className="flex items-center justify-between border-b border-white/10 pb-3">
                <span className="text-sm text-white/60">Approved Classes</span>
                <span className="text-lg font-bold text-lime-300">{approvedClasses}</span>
              </div>
              <div className="flex items-center justify-between border-b border-white/10 pb-3">
                <span className="text-sm text-white/60">Total Bookings</span>
                <span className="text-lg font-bold text-white">{totalBookings}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-white/60">Platform Status</span>

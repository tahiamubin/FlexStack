        ...
        <header className="mx-auto flex h-16 max-w-7xl items-center justify-between px-2">
            ...
            <Link href={"/"}>
              <div className="flex items-center gap-3">
                <Image
                  ...
                  alt="logo"
                />
                <p className="font-bold text-2xl">FlexStack</p>
              </div>
            </Link>
          </div>
          ...
          <ul className="hidden items-center gap-4 md:flex ">
            <li>
              <Link
                href="/"
                className="font-medium text-white relative transition-colors duration-300 hover:text-gray-300 after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full"
                aria-current="page"
              >
                Home
              </Link>
          ...
          {!user && (
            <div className="  hidden items-center gap-4 md:flex ">
              ...
              <Link href="/signup">
                <Button className={'bg-[#CCFF00] text-black'}>Sign Up</Button>
              </Link>
            </div>
          )}
          ...
          <div className="border-t border-separator md:hidden">
            <ul className="flex flex-col gap-2 p-4">
              ...
              <li className="mt-4 flex flex-col gap-2 border-t border-separator pt-4">
                ...
                <Button className="w-full bg-white text-black">Sign Out</Button>
              </li>
            </ul>
          </div>
        )}
